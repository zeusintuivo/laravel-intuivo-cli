...
rem call seedTemplate DailyLog/DailyLog
rem call seedTemplate DailyLog/DailyLogComment


call seedTemplate Immunization/VaccineLogComments
rem call seedTemplate Immunization/VaccineLog
...
rem call seedTemplate Person/Person
